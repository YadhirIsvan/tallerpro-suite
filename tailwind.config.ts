    ...
    extend: {
      colors: {
        ...
        status: {
          ...
          "diagnosis-bg": "hsl(var(--status-diagnosis-bg))",
        ...
        // Metric colors
        metric: {
          sales: "hsl(var(--metric-sales))",
          active: "hsl(var(--metric-active))",
          completed: "hsl(var(--metric-completed))",
          pending: "hsl(var(--metric-pending))",
          productivity: "hsl(var(--metric-productivity))",
      ...
      boxShadow: {
        ...
        glow: "0 0 20px rgba(74, 155, 160, 0.15)",
      },
    },
  },
